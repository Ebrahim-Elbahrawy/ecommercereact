...
import { editProduct, getOneProduct } from "../../redux/action/productAction";
...
const AdminEditProductsHook = (id) => {
  ...
  // get one product
  const productWantEditIt = useSelector((state) => state.allProduct.oneProduct);
  ...
  useEffect(() => {
    if (productWantEditIt.data) {
      setImages(productWantEditIt.data.images);
      setProdName(productWantEditIt.data.title);
      setProdDescription(productWantEditIt.data.description);
      setPriceBefore(productWantEditIt.data.price);
      setQty(productWantEditIt.data.quantity);
      setCatID(productWantEditIt.data.category);
      SetBrandID(productWantEditIt.data.brand);
      setColors(productWantEditIt.data.availableColors);
    }
  }, [productWantEditIt]);
